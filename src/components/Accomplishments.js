    ...
    <div className="py-8 md:16 md:mt-12">
      ...
      <div className="flex flex-col space-y-36">
        <div id="accomplishments" className="w-full h-52 mt-1 activities container-fluid relative">
          <div className="w-full h-52 flex flex-col sm:flex-row justify-between items-center sm:space-x-4 absolute left-0 right-0 -bottom-24 mx-auto px-3 sm:px-8 md:px-16 lg:px-24 xl:px-36 2xl:px-48">
            <div className="sm:w-4/12 lg:w-3/12 h-full flex flex-col justify-center items-center space-y-2 md:space-y-4 bg-christin-secondary">
            ...
            <div className="sm:w-4/12 lg:w-3/12 h-full flex flex-col justify-center items-center space-y-2 md:space-y-4 bg-christin">
            ...
            <div className="sm:w-4/12 lg:w-3/12 h-full flex flex-col justify-center items-center space-y-2 md:space-y-4 bg-christin-primary">
