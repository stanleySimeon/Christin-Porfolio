  ...
  return (
    <div id="home" className="container-fluid px-3 sm:px-8 md:px-16 lg:px-24 xl:px-36 2xl:px-48 relative">
      <div className="flex flex-col items-start justify-center h-screen relative">
        ...
        <button type="button" id="lets-talk-btn" className="bg-christin text-christin-white hover:text-christin-gray font-normal font-montserrat text-sm sm:text-lg md:text-md lg:text-lg text-center py-2 px-8 lg:px-12 mt-4 z-20" onClick={() => window.location.href = '#contacts'}>
          Let&apos;s talk
        </button>
